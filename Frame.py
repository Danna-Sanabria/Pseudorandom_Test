...
class Frame:
    ...
    def initComponents(self):
        ...
        meanTest_button = tk.Button(self.mywindow, text="Prueba de medias", command=self.control.meanTest, width=18, height=2, bg="#ff6c5e",fg="black" , font = ("Georgia", 12), bd=1.5)
        meanTest_button.place(x=100 , y=358)

        VarianceTest = tk.Button(self.mywindow, text="Prueba de varianza", command=self.control.varianceTest, width=18, height=2, bg="#ff6c5e",fg="black" , font = ("Georgia", 12), bd=1.5)
        VarianceTest.place(x=278 , y=358 )

        KSTest = tk.Button(self.mywindow, text="Prueba de KS", command=self.control.KSTest, width=18, height=2, bg="#ff6c5e",fg="black" , font = ("Georgia", 12), bd=1.5)
        KSTest.place(x=456 , y=358)

        Chi2Test = tk.Button(self.mywindow, text="Prueba de Chi2", command=self.control.Chi2Test, width=18, height=2, bg="#ff6c5e",fg="black" , font = ("Georgia", 12), bd=1.5)
        Chi2Test.place(x=634 , y=358)
